...
:installdeps
	...
	cd .deps || goto :error
	call :download go.zip https://download.wireguard.com/windows-toolchain/distfiles/go1.16-2021-02-16.zip e6adc43909b8528babc8d00c528ba4d0acd5343f1db7d4e55528301fb0b1159a || goto :error
